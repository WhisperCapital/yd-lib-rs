...
///
/// @url https://github.com/rust-lang/cargo/issues/985#issuecomment-1407060793
...
fn generate_api_wrapper(hpp_ast_root: &TranslationUnit) {
    let file_path =
