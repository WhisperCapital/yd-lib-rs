...
fn handle_c_fn(entity: &Entity, handlers: &HandlerMap, configs: &HandlerConfigs) -> Vec<String> {
    process_children(
        entity,
        handlers,
        &mut HandlerConfigs {
...
fn handle_spi_stream_code(full_spi_name: &str, full_spi_output_enum_name: &str) -> String {
    format!(
        r#"
