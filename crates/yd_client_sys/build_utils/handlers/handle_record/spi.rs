...
pub fn handle_spi_record(
    ...
    lines.push(format!("\n/* Generated by handle_output_enum_struct */"));
    lines.extend(handle_output_enum_struct(entity, handlers, configs));

    lines.push(format!("\n/* Generated by handle_static_table */"));
    ...
    lines.push(format!("\n/* Generated by handle_c_fn */"));
    lines.extend(handle_c_fn(entity, handlers, configs));

    lines.push(format!("\n/* Generated by handle_fat_spi */"));
